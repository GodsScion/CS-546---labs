...
async function main(){
    ...
    try{
        console.log(await bands.rename(bandCollection[0]._id, "The Weeknd"));     
    }catch(error){ console.log(error);}
    ...
    try{
        console.log(await bands.remove("620dd277e6f398de3752f2a7"));
    }catch(error){ console.log(error);}

    try{
        console.log(await bands.rename("620dd277e6f398de3752f2a7", "The Weeknd"));     
    }catch(error){ console.log(error);}

    try{
        console.log(await bands.rename(bandCollection[0]._id, 53864188126));     
    }catch(error){ console.log(error);}
